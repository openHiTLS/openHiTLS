...
void *PrivPassNewPkeyCtx(void *libCtx, int32_t algId)
{
    (void)libCtx;
...
int32_t PrivPassPubDigest(void *libCtx, int32_t algId, const uint8_t *input, uint32_t inputLen, uint8_t *digest,
    uint32_t *digestLen)
{
    (void)libCtx;
...
int32_t PrivPassPubDecodePubKey(void *libCtx, uint8_t *pubKey, uint32_t pubKeyLen, void **pkeyCtx)
{
    (void)libCtx;
...
int32_t PrivPassPubDecodePrvKey(void *libCtx, void *param, uint8_t *prvKey, uint32_t prvKeyLen, void **pkeyCtx)
{
    (void)libCtx;
    (void)param;
