    ...
    HITLS_Auth_PrivPassToken **challenge)
{
    ...
    if ((temp = BSL_PARAM_FindConstParam(param, AUTH_PARAM_PRIV_PASS_ISSUERNAME)) != NULL && temp->useLen > 0) {
    ...
    if ((temp = BSL_PARAM_FindConstParam(param, AUTH_PARAM_PRIV_PASS_REDEMPTION)) != NULL && temp->useLen > 0) {
