...
static const CidInfo g_allCipherAlgInfo [] = {
    ...
    {CRYPT_CIPHER_AES128_WRAP_NOPAD, "aes128-wrap-nopad"},
    {CRYPT_CIPHER_AES128_WRAP_PAD, "aes128-wrap-pad"},
    ...
    {CRYPT_CIPHER_AES192_WRAP_NOPAD, "aes192-wrap-nopad"},
    {CRYPT_CIPHER_AES192_WRAP_PAD, "aes192-wrap-pad"},
    ...
    {CRYPT_CIPHER_AES256_WRAP_NOPAD, "aes256-wrap-nopad"},
    {CRYPT_CIPHER_AES256_WRAP_PAD, "aes256-wrap-pad"},
