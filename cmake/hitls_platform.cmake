...
if(HITLS_ASM)
    ...
    if(NOT HITLS_ASM_X8664 AND NOT HITLS_ASM_ARMV8 AND NOT HITLS_ASM_ARMV7 AND NOT HITLS_ASM_RISCV64)
        ...
        elseif(_hitls_proc MATCHES "^riscv64")
            set(HITLS_ASM_RISCV64 ON CACHE BOOL "Enable RISC-V 64 assembly optimizations" FORCE)
            message(STATUS "ASM auto-detected architecture: RISC-V 64")
        else()
            message(FATAL_ERROR 
                ...
                "HITLS_ASM_X8664_AVX512/HITLS_ASM_X8664/HITLS_ASM_ARMV8/HITLS_ASM_ARMV7/HITLS_ASM_RISCV64"
            )
        endif()
        unset(_hitls_proc)
    endif()
else()
    if(HITLS_ASM_X8664 OR HITLS_ASM_ARMV8 OR HITLS_ASM_ARMV7 OR HITLS_ASM_RISCV64)
...
if(HITLS_ASM)
    ...
    if(HITLS_ASM_RISCV64)
        math(EXPR _asm_arch_count "${_asm_arch_count} + 1")
    endif()

    if(_asm_arch_count GREATER 1)
        message(FATAL_ERROR "Cannot enable more than one ASM architecture at the same time. "
            "Please set only one of: HITLS_ASM_X8664/HITLS_ASM_X8664_AVX512, HITLS_ASM_ARMV8, HITLS_ASM_ARMV7, HITLS_ASM_RISCV64")
    endif()
endif()
...
elseif(HITLS_ASM_RISCV64)
    message(STATUS "  ASM:          riscv64")
else()
