...
{
    (void)memset_s(filterBuf, *filterBufLen, 0, *filterBufLen); //定义时候改成calloc
    BslBase64DecodeRemoveBlank((const uint8_t *)srcBufm srcBufLen, filterBuf, filterBufLen);
