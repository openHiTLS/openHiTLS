...
#if defined(HITLS_PKI_X509_VFY) || defined(HITLS_PKI_CMS_ENVELOPEDDATA) || defined(HITLS_PKI_CMS_AUTHENTICATEDDATA)
...
#endif // HITLS_PKI_X509_VFY || HITLS_PKI_CMS_ENVELOPEDDATA || HITLS_PKI_CMS_AUTHENTICATEDDATA
