    ...
    bool checkKeyParam, HITLS_X509_Asn1AlgId *signAlgId)
{
    ...
    BSL_Param param[4] = {
        {CRYPT_PARAM_RSA_MD_ID, BSL_PARAM_TYPE_INT32, (void *)&algParam->rsaPss.mdId,
            sizeof(algParam->rsaPss.mdId), 0},
        {CRYPT_PARAM_RSA_MGF1_ID, BSL_PARAM_TYPE_INT32, (void *)&algParam->rsaPss.mgfId,
            sizeof(algParam->rsaPss.mgfId), 0},
        {CRYPT_PARAM_RSA_SALTLEN, BSL_PARAM_TYPE_INT32, (void *)&algParam->rsaPss.saltLen,
