...
**********************************************************************/
E2EE_ClientCtx *E2EE_ClientCreate(void);
...
Description:   Init the client context. E2EE is implemented based on HPKE, so a trusted server public key is required.
Input:         ctx - client context
               algId - E2EE algorithm ID
               clientInfo - client information
Return:        Success - E2EE_SUCCESS
               Failure - other Errcode
**********************************************************************/
uint32_t E2EE_ClientInit(E2EE_ClientCtx *ctx, E2EE_AlgId algId, E2EE_ClientInfo *clientInfo);
...
Input:         ctx - server context
               algIds - supported E2EE algorithm id array.
               algNum - length of algIds
               serverInfo - server information
Return:        Success - E2EE_SUCCESS
               Failure - other Errcode
**********************************************************************/
uint32_t E2EE_ServerInit(E2EE_ServerCtx *ctx, E2EE_AlgId algIds[], uint32_t algNum, E2EE_ServerInfo *serverInfo);
