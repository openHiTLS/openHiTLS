...
typedef enum {
    ...
    CRYPT_PKEY_SPAKE2P = BSL_CID_SPAKE2P,
...
typedef enum {
    ...
    CRYPT_PKEY_PARAID_SPAKE2P_EDWARDS25519_SHA256_HKDF_HMAC_SHA256 = BSL_CID_SPAKE2P_PARAMS, /* Example, replace BSL_CID_SPAKE2P_PARAMS with actual value */
