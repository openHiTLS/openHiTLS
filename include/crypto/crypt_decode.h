 ...
 * @param inFormat Input data format
 * @param inType Input data type
 * @param outFormat Output data format
...
typedef struct _CRYPT_DECODER_PoolCtx {
...
typedef enum {
    /** Set the source data */
    CRYPT_DECODE_POOL_CMD_SET_SOURCE_DATA,
