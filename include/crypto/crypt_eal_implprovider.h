...
typedef void *(*CRYPT_EAL_ImplCipherNewCtx)(void *provCtx, int32_t algId, CRYPT_Param *param);
...
typedef void *(*CRYPT_EAL_ImplPkeyMgmtNewCtx)(void *provCtx, int32_t algId, CRYPT_Param *param);
...
typedef void *(*CRYPT_EAL_ImplMdNewCtx)(void *provCtx, int32_t algId, CRYPT_Param *param);
...
typedef void *(*CRYPT_EAL_ImplMacNewCtx)(void *provCtx, int32_t algId, CRYPT_Param *param);
...
typedef void *(*CRYPT_EAL_ImplKdfNewCtx)(void *provCtx, int32_t algId, CRYPT_Param *param);
