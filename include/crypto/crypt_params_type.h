...
#define CRYPT_PARAM_SEED_BASE 300
#define CRYPT_PARAM_SEED_GETENTROPY       (CRYPT_PARAM_SEED_BASE + 1)
#define CRYPT_PARAM_SEED_CLEANENTROPY     (CRYPT_PARAM_SEED_BASE + 2)
#define CRYPT_PARAM_SEED_GETNONCE         (CRYPT_PARAM_SEED_BASE + 3)
#define CRYPT_PARAM_SEED_CLEANNONCE       (CRYPT_PARAM_SEED_BASE + 4)
