...
#define CRYPT_PARAM_CKKS_BASE         800
#define CRYPT_PARAM_CKKS_A            (CRYPT_PARAM_CKKS_BASE + 1)
#define CRYPT_PARAM_CKKS_B            (CRYPT_PARAM_CKKS_BASE + 2)
#define CRYPT_PARAM_CKKS_S            (CRYPT_PARAM_CKKS_BASE + 3)
#define CRYPT_PARAM_CKKS_M            (CRYPT_PARAM_CKKS_BASE + 4)
#define CRYPT_PARAM_CKKS_PREC         (CRYPT_PARAM_CKKS_BASE + 5)
#define CRYPT_PARAM_CKKS_BITS         (CRYPT_PARAM_CKKS_BASE + 7)
