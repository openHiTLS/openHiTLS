...
#define CRYPT_PARAM_CAP_TLS_SIGNALG_PARA_ID                       (CRYPT_PARAM_CAP_TLS_SIGNALG_BASE + 4)
#define CRYPT_PARAM_CAP_TLS_SIGNALG_SIGNWITHMD_ID                 (CRYPT_PARAM_CAP_TLS_SIGNALG_BASE + 5)
#define CRYPT_PARAM_CAP_TLS_SIGNALG_SIGN_ID                       (CRYPT_PARAM_CAP_TLS_SIGNALG_BASE + 6)
#define CRYPT_PARAM_CAP_TLS_SIGNALG_MD_ID                         (CRYPT_PARAM_CAP_TLS_SIGNALG_BASE + 7)
#define CRYPT_PARAM_CAP_TLS_SIGNALG_SEC_BITS                      (CRYPT_PARAM_CAP_TLS_SIGNALG_BASE + 8)
#define CRYPT_PARAM_CAP_TLS_SIGNALG_CHAIN_VERSION_BITS            (CRYPT_PARAM_CAP_TLS_SIGNALG_BASE + 9)
#define CRYPT_PARAM_CAP_TLS_SIGNALG_CERT_VERSION_BITS             (CRYPT_PARAM_CAP_TLS_SIGNALG_BASE + 10)
