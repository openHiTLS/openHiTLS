...
#define CRYPT_PARAM_CAP_TLS_GROUP_BASE 1200
...
#define CRYPT_PARAM_CAP_TLS_SIGNALG_BASE 1250
...
#define CRYPT_PARAM_CAP_TLS_SIGNALG_SIGNWITHMD_ID                 (CRYPT_PARAM_CAP_TLS_SIGNALG_BASE + 7)
#define CRYPT_PARAM_CAP_TLS_SIGNALG_SIGNWITHMD_OID                (CRYPT_PARAM_CAP_TLS_SIGNALG_BASE + 8)
#define CRYPT_PARAM_CAP_TLS_SIGNALG_SIGN_ID                       (CRYPT_PARAM_CAP_TLS_SIGNALG_BASE + 9)
#define CRYPT_PARAM_CAP_TLS_SIGNALG_MD_ID                         (CRYPT_PARAM_CAP_TLS_SIGNALG_BASE + 10)
#define CRYPT_PARAM_CAP_TLS_SIGNALG_MD_OID                        (CRYPT_PARAM_CAP_TLS_SIGNALG_BASE + 11)
#define CRYPT_PARAM_CAP_TLS_SIGNALG_SEC_BITS                      (CRYPT_PARAM_CAP_TLS_SIGNALG_BASE + 12)
#define CRYPT_PARAM_CAP_TLS_SIGNALG_CHAIN_VERSION_BITS            (CRYPT_PARAM_CAP_TLS_SIGNALG_BASE + 13)
#define CRYPT_PARAM_CAP_TLS_SIGNALG_CERT_VERSION_BITS             (CRYPT_PARAM_CAP_TLS_SIGNALG_BASE + 14)
