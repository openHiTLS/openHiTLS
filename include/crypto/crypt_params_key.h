...
#define CRYPT_PARAM_RSA_SEED_XP      (CRYPT_PARAM_RSA_BASE + 13)
#define CRYPT_PARAM_RSA_SEED_XQ      (CRYPT_PARAM_RSA_BASE + 14)
#define CRYPT_PARAM_RSA_SEED_P_R1    (CRYPT_PARAM_RSA_BASE + 15)
#define CRYPT_PARAM_RSA_SEED_P_R2    (CRYPT_PARAM_RSA_BASE + 16)
#define CRYPT_PARAM_RSA_SEED_Q_R1    (CRYPT_PARAM_RSA_BASE + 17)
#define CRYPT_PARAM_RSA_SEED_Q_R2    (CRYPT_PARAM_RSA_BASE + 18)
