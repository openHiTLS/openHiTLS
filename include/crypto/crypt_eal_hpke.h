 ...
 *
 * @param cipher [IN] HPKE cipher suite
 ...
 * @param encapsulatedKey [OUT] Buffer to store the encapsulated key
 * @param encapsulatedKeyLen [IN/OUT] On input, the length of the buffer; on output, the length of the encapsulated key
 *
 ...
 * @param cipherTextLen [IN/OUT] Length of ciphertext
 * 
 * @retval #CRYPT_SUCCESS if successful
