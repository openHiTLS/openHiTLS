...
typedef enum {
    CRYPT_HPKE_MODE_BASE = 0x00,      /* 基础模式 */
...
} CRYPT_HPKE_KEM_AlgId;                                          /* KEM算法标识符 */

typedef enum {
    CRYPT_KDF_HKDF_SHA256 = 0x0001,    /* HKDF-SHA256 */
    CRYPT_KDF_HKDF_SHA384 = 0x0002,    /* HKDF-SHA384 */
    CRYPT_KDF_HKDF_SHA512 = 0x0003     /* HKDF-SHA512 */
} CRYPT_HPKE_KDF_AlgId;                                      /* KDF算法标识符 */

typedef enum {
    CRYPT_AEAD_AES_GCM_128 = 0x0001,    /* AES-128-GCM */
    CRYPT_AEAD_AES_GCM_256 = 0x0002,    /* AES-256-GCM */
    CRYPT_AEAD_CHACHA20_POLY1305 = 0x0003,  /* ChaCha20-Poly1305 */
    CRYPT_AEAD_EXPORT_ONLY = 0xFFFF      /* 仅用于导出 */
} CRYPT_HPKE_AEAD_AlgId;                                       /* AEAD算法标识符 */
