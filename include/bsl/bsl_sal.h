 ...
 * Time consuming  : Not time-consuming.
 * @param sockId [IN] Socket file descriptor ID
 * @param addr [IN] Address to be accepted
 * @param len [IN] Address length
 * @retval If the operation succeeds, BSL_SUCCESS is returned
...
typedef enum {
    ...
    BSL_SAL_NET_GET_SOCK_NAME_CB_FUNC,                  /* BslSalGetSockName */
    ...
    BSL_SAL_NET_SOCK_ACCEPT_CB_FUNC,                    /* BslSalSockAccept */
    ...
    BSL_SAL_NET_SOCKADDR_COPY_CB_FUNC,
    BSL_SAL_NET_SOCKADDR_GET_FAMILY_CB_FUNC,
