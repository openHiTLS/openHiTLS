...
typedef enum {
    ...
    /* UDP uses 0x2XX */
    BSL_UIO_DGRAM_GET_PEER = 0x200,
    BSL_UIO_DGRAM_SET_PEER, /* Destination for the data */

    BSL_UIO_DGRAM_SET_RECV_TIMEOUT,
    BSL_UIO_DGRAM_GET_RECV_TIMEOUT,
    BSL_UIO_DGRAM_SET_SEND_TIMEOUT,
    BSL_UIO_DGRAM_GET_SEND_TIMEOUT,
