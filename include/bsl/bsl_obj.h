...
typedef enum {
    ...
    BSL_CID_AES128_GCM_SIV = 2227,
    BSL_CID_AES256_GCM_SIV = 2228,
    ...
    BSL_CID_CMS_ORI_KEM = 2501,

    BSL_CID_ASCON_AEAD128 = 2511,
    BSL_CID_ASCON_AEAD128A = 2512,
    BSL_CID_ASCON_AEAD80PQ = 2513,

    BSL_CID_ASCON_HASH128 = 2514,
    BSL_CID_ASCON_HASH128A = 2515,
    ...
    BSL_CID_X509CRL,
    BSL_CID_SMIMECAP,
    BSL_CID_PKCS9_AT_CMSALGORITHMPROTECTION, /**< RFC 6211 CMSAlgorithmProtection attribute OID */
