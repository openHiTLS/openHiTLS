...
#define HITLS_CMS_PARAM_CONTENT_ENC_ALG             (HITLS_PKI_PARAM_CMS_BASE + 12)
#define HITLS_CMS_PARAM_CONTENT_TYPE                (HITLS_PKI_PARAM_CMS_BASE + 13)
#define HITLS_CMS_PARAM_RECIPIENT_TYPE              (HITLS_PKI_PARAM_CMS_BASE + 14)
#define HITLS_CMS_PARAM_RECIPIENT_CERT              (HITLS_PKI_PARAM_CMS_BASE + 15)
#define HITLS_CMS_PARAM_RECIPIENT_KEY_ENC_ALG       (HITLS_PKI_PARAM_CMS_BASE + 16)
#define HITLS_CMS_PARAM_MAC_ALG                     (HITLS_PKI_PARAM_CMS_BASE + 17)
#define HITLS_CMS_PARAM_NO_AUTH_ATTRS               (HITLS_PKI_PARAM_CMS_BASE + 18)
