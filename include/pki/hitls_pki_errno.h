...
typedef enum {
    ...
    HITLS_X509_ERR_VFY_DIFFERENT_CRL_SCOPE,
    ...
    HITLS_X509_ERR_EXT_IDP,
    HITLS_X509_ERR_EXT_REASONFLAGS,
    HITLS_X509_ERR_EXT_DISTPOINT,
    HITLS_X509_ERR_EXT_CRLDP,
    HITLS_X509_ERR_PARSE_CRLDP,
    HITLS_X509_ERR_CRLDP_INVALID,
