...
typedef enum {
    ...
    HITLS_X509_ERR_VFY_PURPOSE_UNMATCH,
    HITLS_X509_ERR_KU_IS_NONE,
    HITLS_X509_ERR_VFY_IP_FAIL,
    HITLS_X509_ERR_VFY_EXTENSIONS_REQUIRE_V3,
    HITLS_X509_ERR_VFY_INTERCA_INVALID_VERSION,
    HITLS_X509_ERR_VFY_INTERCA_INVALID_BCONS,
    ...
    HITLS_X509_ERR_CERT_CN_NOT_FOUND,
    HITLS_X509_ERR_CERT_THISUPDATE_UNEXIST,
	HITLS_X509_ERR_CERT_NEXTUPDATE_UNEXIST,
    HITLS_X509_ERR_CERT_NOT_MATCH_KEY,
    ...
    HITLS_X509_ERR_SAN_NOT_FOUND,
    HITLS_X509_ERR_PARSE_SAN_ITEM,
    ...
    HITLS_CMS_ERR_INVALID_FORMAT,
    HITLS_CMS_ERR_INVALID_PARAM,
    HITLS_CMS_ERR_PARSE_TYPE,
    HITLS_CMS_ERR_UNSUPPORTED_TYPE,
    HITLS_CMS_ERR_CTX_IS_NOT_INIT,
    HITLS_CMS_ERR_ENCAPCONT_TYPE,
    HITLS_CMS_ERR_VERSION_INVALID,
    HITLS_CMS_ERR_SIGNEDDATA_NO_CONTENT,
    HITLS_CMS_ERR_SIGNEDDATA_NO_SIGNERINFO,
    HITLS_CMS_ERR_SIGNEDDATA_CONTENT_MISMATCH,
    HITLS_CMS_ERR_SIGNEDDATA_MSG_HASH_MISMATCH,
    HITLS_CMS_ERR_SIGNEDDATA_SIGNEDATTRS_INVALID,
    HITLS_CMS_ERR_SIGNEDDATA_NO_FIND_CERT,
    HITLS_CMS_ERR_SIGNEDDATA_OBTAIN_PUB_FAILED,
    HITLS_CMS_ERR_SIGNEDDATA_NO_FIND_HASH,
    HITLS_CMS_ERR_SIGNEDDATA_NO_FIND_SIGNERINFO_ATTR,
    HITLS_CMS_ERR_SIGNEDDATA_SIGNALG_INVALID,
    HITLS_CMS_ERR_INVALID_SIGNEDDATA_MSG,
    HITLS_CMS_ERR_NOT_ENOUGH_INFO_KEY,
    HITLS_CMS_ERR_IS_NOT_DETACHED_SIGNEDDATA,
    ...
    HITLS_CMS_ERR_ENVELOPEDDATA_CIPHER_FAIL,
    HITLS_CMS_ERR_RECIPIENT_KEY_DECRYPT_FAIL,
    HITLS_CMS_ERR_RECIPIENT_MISMATCH,
    HITLS_CMS_ERR_INVALID_RECIPIENT_TYPE,
    HITLS_CMS_ERR_NO_MATCHING_RECIPIENT,
    HITLS_CMS_ERR_NO_RECIPIENT,
    HITLS_CMS_ERR_KTRI_CERT_REQUIRED,
    HITLS_CMS_ERR_KTRI_PRIKEY_REQUIRED,
    HITLS_CMS_ERR_ATTACHED_STREAM_UNSUPPORTED,
    // HITLS_CMS_ERR_CEK_DECRYPT_FAIL,
