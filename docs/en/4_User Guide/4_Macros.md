# Macros
## Feature Macros
If using the build method provided by openHiTLS, there's no need to manually set macros. Refer to [1_Build and Installation Guide](1_Build%20and%20Installation%20Guide.md), use `--enable` to enable a feature, or `--disable` to disable it.

For the complete list of feature macros, refer to [feature.json](../../../config/json/feature.json): libs/hitls_/features/\*/
...
## Setting Macros
Refer to [1_Build and Installation Guide](1_Build%20and%20Installation%20Guide.md), use `--add_options` to add macros or `--del_options` to delete macros.
