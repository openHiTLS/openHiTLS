...
#if defined(HITLS_TLS_PROTO_DTLS12) && !defined(HITLS_TLS_PROTO_DTLS)
...
// feature
    ...
    #endif
    #ifndef HITLS_TLS_FEATURE_DEFAULT_COOKIE
        #define HITLS_TLS_FEATURE_DEFAULT_COOKIE
    #endif
    ...
    #endif
    #ifndef HITLS_TLS_FEATURE_SESSION_CACHE_CB
        #define HITLS_TLS_FEATURE_SESSION_CACHE_CB
    #endif
    #ifndef HITLS_TLS_FEATURE_SESSION_CUSTOM_TICKET
        #define HITLS_TLS_FEATURE_SESSION_CUSTOM_TICKET
    #endif
#endif
    ...
    defined(HITLS_TLS_FEATURE_SESSION_CACHE_CB) || defined(HITLS_TLS_FEATURE_SESSION_CUSTOM_TICKET)
    #ifndef HITLS_TLS_FEATURE_SESSION
        #define HITLS_TLS_FEATURE_SESSION
    #endif
#endif

#if defined(HITLS_TLS_FEATURE_SESSION_CACHE_CB) || defined(HITLS_TLS_FEATURE_SESSION_CUSTOM_TICKET)
    #ifndef HITLS_TLS_FEATURE_SESSION_ID
        #define HITLS_TLS_FEATURE_SESSION_ID
    #endif
#endif
...
// MAINTAIN
#if defined(HITLS_TLS_MAINTAIN) && !defined(HITLS_TLS_MAINTAIN_KEYLOG)
...
#if defined(HITLS_TLS_CONNECTION) && !defined(HITLS_TLS_CONNECTION_INFO_NEGOTIATION)
    #define HITLS_TLS_CONNECTION_INFO_NEGOTIATION
#endif
#if defined(HITLS_TLS_CONNECTION_INFO_NEGOTIATION) && !defined(HITLS_TLS_CONNECTION)
...
#if defined(HITLS_TLS_CONFIG_CERT_CALLBACK) && !defined(HITLS_PKI_X509_VFY_CB)
    #define HITLS_PKI_X509_VFY_CB
#endif

#if (defined(HITLS_TLS_PROTO_DTLS12) || defined(HITLS_TLS_PROTO_TLS13)) && !defined(HITLS_TLS_EXTENSION_COOKIE)
    ...
    #endif
#endif
#if defined(HITLS_TLS_SUITE_CIPHER_AEAD) && defined(HITLS_TLS_SUITE_KX_ECDHE) && \
    defined(HITLS_TLS_SUITE_AUTH_SM2) && !defined(HITLS_TLS_SUITE_ECDHE_SM4_GCM_SM3)
    ...
    !defined(HITLS_TLS_SUITE_ECDHE_SM4_CBC_SM3)
...
#if defined(HITLS_TLS_SUITE_CIPHER_CBC) && !defined(HITLS_TLS_CALLBACK_CRYPT_HMAC_PRIMITIVES)
    #define HITLS_TLS_CALLBACK_CRYPT_HMAC_PRIMITIVES
#endif

#if defined(HITLS_TLS_SUITE_CIPHER_CBC) && !defined(HITLS_TLS_FEATURE_ETM)
