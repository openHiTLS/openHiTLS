...
/* PKEY */
    ...
    #endif
    #ifndef HITLS_CRYPTO_MCELIECE
        #define HITLS_CRYPTO_MCELIECE
    #endif
...
#undef HITLS_INT128
    ...
    defined(HITLS_CRYPTO_FRODOKEM) || defined(HITLS_CRYPTO_MCELIECE)
...
#if (defined(HITLS_CRYPTO_MLKEM) || defined(HITLS_CRYPTO_FRODOKEM) || defined(HITLS_CRYPTO_MCELIECE) || \
...
#define HITLS_CRYPTO_SM4_ASM
    ...
    #ifndef HITLS_CRYPTO_CHACHA20POLY1305_X8664
        #define HITLS_CRYPTO_CHACHA20POLY1305_X8664
    #endif
    #ifndef HITLS_CRYPTO_GHASH_X8664
        #define HITLS_CRYPTO_GHASH_X8664
    #endif
#endif

#if defined(HITLS_CRYPTO_MODES_ARMV8)
    #ifndef HITLS_CRYPTO_CHACHA20POLY1305_ARMV8
        #define HITLS_CRYPTO_CHACHA20POLY1305_ARMV8
    #endif
    #ifndef HITLS_CRYPTO_GHASH_ARMV8
        #define HITLS_CRYPTO_GHASH_ARMV8
    #endif
#endif
...
#define HITLS_CRYPTO_BN_ASM
    ...
    #ifndef HITLS_CRYPTO_CURVE_NISTP256_X8664
        #define HITLS_CRYPTO_CURVE_NISTP256_X8664
    #endif
    #ifndef HITLS_CRYPTO_CURVE_NISTP384_X8664
        #define HITLS_CRYPTO_CURVE_NISTP384_X8664
    #endif
    #ifndef HITLS_CRYPTO_CURVE_SM2_X8664
        #define HITLS_CRYPTO_CURVE_SM2_X8664
    #endif
#endif

#if defined(HITLS_CRYPTO_ECC_ARMV8)
    #ifndef HITLS_CRYPTO_CURVE_NISTP256_ARMV8
        #define HITLS_CRYPTO_CURVE_NISTP256_ARMV8
    #endif
    #ifndef HITLS_CRYPTO_CURVE_NISTP384_ARMV8
        #define HITLS_CRYPTO_CURVE_NISTP384_ARMV8
    #endif
    #ifndef HITLS_CRYPTO_CURVE_SM2_ARMV8
