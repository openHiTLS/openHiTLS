...
/* PKEY */
    ...
    #undef HITLS_CRYPTO_NIST_USE_ACCEL
#endif
...
#if (defined(HITLS_CRYPTO_SHA3_X8664) || defined(HITLS_CRYPTO_SHA3_ARMV8)) && !defined(HITLS_CRYPTO_SHA3_ASM)
#define HITLS_CRYPTO_SHA3_ASM
#endif
