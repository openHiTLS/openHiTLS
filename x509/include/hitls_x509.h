...
typedef enum {
    ...
    HITLS_X509_CERT_GET_SUBJECT_DNNAME,
    HITLS_X509_CERT_GET_ISSUER_DNNAME,
    HITLS_X509_CERT_GET_SERIALNUM,
    HITLS_X509_CERT_GET_BEFORE_TIME,
    HITLS_X509_CERT_GET_AFTER_TIME
} HITLS_X509_CertCmd;
