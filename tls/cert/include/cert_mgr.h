...
/**
 * @brief   Look up and return the appropriate certificate resource struct in the hash table according to the keyType.
 *
 * @param   mgrCtx   [IN] Certificate management struct
...
/**
 * @brief   Insert certificate resource struct corresponding to keyType into certificate hash table.
 *
 * @param   mgrCtx   [IN] Certificate management struct
 * @param   keyType [IN] Certificate public key type
 * @param   certPair [IN] Certificate resource struct. The certPair is set NULL by the invoker.
