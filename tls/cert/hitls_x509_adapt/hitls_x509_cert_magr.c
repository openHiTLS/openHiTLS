...
{
    HITLS_Lib_Ctx *libCtx = (config == NULL || config->certMgrCtx == NULL) ? NULL : config->certMgrCtx->libCtx;
    const char *attrName = (config == NULL || config->certMgrCtx == NULL) ? NULL : config->certMgrCtx->attrName;
...
// TODO: The implement will be repalced with table of TLS context
static HITLS_SignHashAlgo BslCid2SignHashAlgo(BslCid signAlgId, BslCid mdAlgId)
{
    typedef struct {
        BslCid signAlgId;
        BslCid mdAlgId;
    ...
    static SignHashMap signMap[] = {
        { BSL_CID_SHA1WITHRSA, BSL_CID_SHA1, CERT_SIG_SCHEME_RSA_PKCS1_SHA1 },
        { BSL_CID_SHA224WITHRSAENCRYPTION, BSL_CID_SHA224, CERT_SIG_SCHEME_RSA_PKCS1_SHA224 },
        { BSL_CID_SHA256WITHRSAENCRYPTION, BSL_CID_SHA256, CERT_SIG_SCHEME_RSA_PKCS1_SHA256 },
        { BSL_CID_SHA384WITHRSAENCRYPTION, BSL_CID_SHA384, CERT_SIG_SCHEME_RSA_PKCS1_SHA384 },
        { BSL_CID_SHA512WITHRSAENCRYPTION, BSL_CID_SHA512, CERT_SIG_SCHEME_RSA_PKCS1_SHA512 },
        { BSL_CID_RSASSAPSS, BSL_CID_SHA256, CERT_SIG_SCHEME_RSA_PSS_PSS_SHA256 },
        { BSL_CID_RSASSAPSS, BSL_CID_SHA384, CERT_SIG_SCHEME_RSA_PSS_PSS_SHA384 },
        { BSL_CID_RSASSAPSS, BSL_CID_SHA512, CERT_SIG_SCHEME_RSA_PSS_PSS_SHA512 },
        { BSL_CID_ECDSAWITHSHA1, BSL_CID_SHA1, CERT_SIG_SCHEME_ECDSA_SHA1 },
        { BSL_CID_ECDSAWITHSHA224, BSL_CID_SHA224, CERT_SIG_SCHEME_ECDSA_SHA224 },
        { BSL_CID_ECDSAWITHSHA256, BSL_CID_SHA256, CERT_SIG_SCHEME_ECDSA_SECP256R1_SHA256 },
        { BSL_CID_ECDSAWITHSHA384, BSL_CID_SHA384, CERT_SIG_SCHEME_ECDSA_SECP384R1_SHA384 },
        { BSL_CID_ECDSAWITHSHA512, BSL_CID_SHA512, CERT_SIG_SCHEME_ECDSA_SECP521R1_SHA512 },
#ifdef HITLS_TLS_PROTO_TLCP11
        { BSL_CID_SM2DSAWITHSM3, BSL_CID_SM3, CERT_SIG_SCHEME_SM2_SM3 },
#endif
        { BSL_CID_ED25519, BSL_CID_SHA512, CERT_SIG_SCHEME_ED25519 },
        { BSL_CID_DSAWITHSHA1, BSL_CID_SHA1, CERT_SIG_SCHEME_DSA_SHA1 },
        { BSL_CID_DSAWITHSHA224, BSL_CID_SHA224, CERT_SIG_SCHEME_DSA_SHA224 },
        { BSL_CID_DSAWITHSHA256, BSL_CID_SHA256, CERT_SIG_SCHEME_DSA_SHA256 },
        { BSL_CID_DSAWITHSHA384, BSL_CID_SHA384, CERT_SIG_SCHEME_DSA_SHA384 },
        { BSL_CID_DSAWITHSHA512, BSL_CID_SHA512, CERT_SIG_SCHEME_DSA_SHA512 },
    };
    for (size_t i = 0; i < sizeof(signMap) / sizeof(signMap[0]); i++) {
        if (signMap[i].signAlgId == signAlgId && signMap[i].mdAlgId == mdAlgId) {
...
static int32_t CertCtrlGetSignAlgo(HITLS_CERT_X509 *cert, HITLS_SignHashAlgo *algSign)
{
    ...
    *algSign = BslCid2SignHashAlgo(signAlgCid, hashCid);
