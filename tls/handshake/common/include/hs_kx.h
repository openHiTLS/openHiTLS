...
#ifndef HITLS_MAX_OTHER_SECRET_SIZE
#define HITLS_MAX_OTHER_SECRET_SIZE 1536
#endif
#define MAX_PRE_MASTER_SECRET_SIZE (sizeof(uint16_t) + HITLS_MAX_OTHER_SECRET_SIZE + sizeof(uint16_t) + \
    HS_PSK_MAX_LEN)
