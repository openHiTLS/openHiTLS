...
#define HS_EX_TYPE_CERT_WITH_EXTERNAL_PSK 33u
...
#define HS_EX_TYPE_CONNECTION_ID 54u
#define HS_EX_TYPE_QUIC_TRANSPORT_PARAMETERS 57u
...
#define HS_EX_TYPE_ID_CONNECTION_ID 28
#define HS_EX_TYPE_ID_QUIC_TRANSPORT_PARAMETERS 29
#define HS_EX_TYPE_ID_CERT_WITH_EXTERNAL_PSK 30
...
#define HS_EX_TYPE_TLS_ALLOWED_OF_CLIENT_HELLO                                                                    \
    (HS_EX_TYPE_MASK(HS_EX_TYPE_ID_SERVER_NAME) | HS_EX_TYPE_MASK(HS_EX_TYPE_ID_MAX_FRAGMENT_LENGTH) |            \
        ...
        HS_EX_TYPE_MASK(HS_EX_TYPE_ID_CONNECTION_ID) |                                                            \
        HS_EX_TYPE_MASK(HS_EX_TYPE_ID_QUIC_TRANSPORT_PARAMETERS) |                                                \
        HS_EX_TYPE_MASK(HS_EX_TYPE_ID_CERT_WITH_EXTERNAL_PSK) |                                                   \
...
#define HS_EX_TYPE_TLS1_3_ALLOWED_OF_SERVER_HELLO                                                             \
    (HS_EX_TYPE_MASK(HS_EX_TYPE_ID_SUPPORTED_VERSIONS) | HS_EX_TYPE_MASK(HS_EX_TYPE_ID_KEY_SHARE) |           \
        HS_EX_TYPE_MASK(HS_EX_TYPE_ID_PRE_SHARED_KEY) | HS_EX_TYPE_MASK(HS_EX_TYPE_ID_CONNECTION_ID) |           \
        HS_EX_TYPE_MASK(HS_EX_TYPE_ID_CERT_WITH_EXTERNAL_PSK))
