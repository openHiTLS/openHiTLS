...
static const struct {
    ...
    {HITLS_X509_ERR_VFY_ISSUE_CERT_NOT_FOUND_LOCALLY, ALERT_UNKNOWN_CA},
    {HITLS_X509_ERR_VFY_SELF_SIGNED_CERT_IN_CHAIN, ALERT_UNKNOWN_CA},
    {HITLS_X509_ERR_VFY_SELF_ISSUED_CERT_IN_CHAIN, ALERT_UNKNOWN_CA},
    {HITLS_X509_ERR_VFY_UNABLE_TO_VERIFY_LEAF_SIGNATURE, ALERT_UNKNOWN_CA},
