...
int HLT_RpcProviderTlsNewCtx(HLT_Process *peerProcess, TLS_VERSION tlsVersion, bool isClient,
    char **providerNames, int32_t *providerLibFmts, int32_t providerCnt, char *attrName)
{
    int ret;
    uint64_t cmdIndex;
