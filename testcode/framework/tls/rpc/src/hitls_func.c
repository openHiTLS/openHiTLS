...
static const HitlsConfig g_signatureList[] = {
    ...
    {"CERT_SIG_SCHEME_COMPOSITE_MLDSA44_RSA2048_PSS_SHA256", CERT_SIG_SCHEME_COMPOSITE_MLDSA44_RSA2048_PSS_SHA256},
    {"CERT_SIG_SCHEME_COMPOSITE_MLDSA44_RSA2048_PKCS15_SHA256",
        CERT_SIG_SCHEME_COMPOSITE_MLDSA44_RSA2048_PKCS15_SHA256},
    {"CERT_SIG_SCHEME_COMPOSITE_MLDSA44_ED25519_SHA512", CERT_SIG_SCHEME_COMPOSITE_MLDSA44_ED25519_SHA512},
    {"CERT_SIG_SCHEME_COMPOSITE_MLDSA44_ECDSA_P256_SHA256", CERT_SIG_SCHEME_COMPOSITE_MLDSA44_ECDSA_P256_SHA256},
    ...
    {"CERT_SIG_SCHEME_COMPOSITE_MLDSA65_RSA4096_PKCS15_SHA512",
        CERT_SIG_SCHEME_COMPOSITE_MLDSA65_RSA4096_PKCS15_SHA512},
    {"CERT_SIG_SCHEME_COMPOSITE_MLDSA65_ECDSA_P256_SHA512", CERT_SIG_SCHEME_COMPOSITE_MLDSA65_ECDSA_P256_SHA512},
    {"CERT_SIG_SCHEME_COMPOSITE_MLDSA65_ECDSA_P384_SHA512", CERT_SIG_SCHEME_COMPOSITE_MLDSA65_ECDSA_P384_SHA512},
    {"CERT_SIG_SCHEME_COMPOSITE_MLDSA65_ECDSA_BRAINPOOLP256R1_SHA512",
        CERT_SIG_SCHEME_COMPOSITE_MLDSA65_ECDSA_BRAINPOOLP256R1_SHA512},
    {"CERT_SIG_SCHEME_COMPOSITE_MLDSA65_ED25519_SHA512", CERT_SIG_SCHEME_COMPOSITE_MLDSA65_ED25519_SHA512},
    {"CERT_SIG_SCHEME_COMPOSITE_MLDSA87_ECDSA_P384_SHA512", CERT_SIG_SCHEME_COMPOSITE_MLDSA87_ECDSA_P384_SHA512},
    ...
    {"CERT_SIG_SCHEME_COMPOSITE_MLDSA87_RSA4096_PSS_SHA512",
        CERT_SIG_SCHEME_COMPOSITE_MLDSA87_RSA4096_PSS_SHA512},
    {"CERT_SIG_SCHEME_COMPOSITE_MLDSA87_ECDSA_P521_SHA512", CERT_SIG_SCHEME_COMPOSITE_MLDSA87_ECDSA_P521_SHA512},
    ...
    int *providerLibFmts, int providerCnt)
{
    ...
    for (int i = 0; i < providerCnt; i++) {
        ...
        char attrName[512] = {0};
        memcpy(attrName, "provider?", strlen("provider?") + 1);
                             ...
                             char *name, HitlsConfigType type)
{
    ...
    if (strlen(name) >= sizeof(configArray)) {
        return ERROR;
    }
    memcpy(configArray, name, strlen(name) + 1);

    configSize = 0;
    token = strtok_r(configArray, ":", &rest);
    do {
