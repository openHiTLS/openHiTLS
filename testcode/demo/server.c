...
int main(int32_t argc, char *argv[])
{
    ...
    // Initialize the provider and its random number, where using default entropy source,
    // users can choose to use their own entropy source by using CRYPT_EAL_ProviderRandInitCtx
