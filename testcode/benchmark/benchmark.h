...
typedef int32_t (*KeyGen)(void *ctx);
typedef int32_t (*KeyDerive)(void *ctx);
typedef int32_t (*Enc)(void *ctx);
typedef int32_t (*Dec)(void *ctx);
typedef int32_t (*Sign)(void *ctx);
typedef int32_t (*Verify)(void *ctx);
