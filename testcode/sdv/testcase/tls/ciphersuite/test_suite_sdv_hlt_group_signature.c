...
void SetCert(HLT_Ctx_Config *ctxConfig, char *cert)
{
    ...
    } else if (strncmp(cert, "COMPOSITE_MLDSA44_RSA2048_PSS_SHA256", strlen("COMPOSITE_MLDSA44_RSA2048_PSS_SHA256")) == 0) {
        HLT_SetCertPath(ctxConfig, COMPOSITE_MLDSA44_RSA2048_PSS_SHA256_CA_PATH,
            COMPOSITE_MLDSA44_RSA2048_PSS_SHA256_CHAIN_PATH, COMPOSITE_MLDSA44_RSA2048_PSS_SHA256_EE_PATH,
            COMPOSITE_MLDSA44_RSA2048_PSS_SHA256_PRIV_PATH, "NULL", "NULL");
    } else if (strncmp(cert, "COMPOSITE_MLDSA44_RSA2048_PKCS15_SHA256", strlen("COMPOSITE_MLDSA44_RSA2048_PKCS15_SHA256")) == 0) {
        HLT_SetCertPath(ctxConfig, COMPOSITE_MLDSA44_RSA2048_PKCS15_SHA256_CA_PATH,
            COMPOSITE_MLDSA44_RSA2048_PKCS15_SHA256_CHAIN_PATH, COMPOSITE_MLDSA44_RSA2048_PKCS15_SHA256_EE_PATH,
            COMPOSITE_MLDSA44_RSA2048_PKCS15_SHA256_PRIV_PATH, "NULL", "NULL");
    } else if (strncmp(cert, "COMPOSITE_MLDSA44_ED25519_SHA512", strlen("COMPOSITE_MLDSA44_ED25519_SHA512")) == 0) {
        HLT_SetCertPath(ctxConfig, COMPOSITE_MLDSA44_ED25519_SHA512_CA_PATH,
            COMPOSITE_MLDSA44_ED25519_SHA512_CHAIN_PATH, COMPOSITE_MLDSA44_ED25519_SHA512_EE_PATH,
            COMPOSITE_MLDSA44_ED25519_SHA512_PRIV_PATH, "NULL", "NULL");
    } else if (strncmp(cert, "COMPOSITE_MLDSA44_ECDSA_P256_SHA256", strlen("COMPOSITE_MLDSA44_ECDSA_P256_SHA256")) == 0) {
        HLT_SetCertPath(ctxConfig, COMPOSITE_MLDSA44_ECDSA_P256_SHA256_CA_PATH,
            COMPOSITE_MLDSA44_ECDSA_P256_SHA256_CHAIN_PATH, COMPOSITE_MLDSA44_ECDSA_P256_SHA256_EE_PATH,
            COMPOSITE_MLDSA44_ECDSA_P256_SHA256_PRIV_PATH, "NULL", "NULL");
    } else if (strncmp(cert, "COMPOSITE_MLDSA65_RSA3072_PSS_SHA512", strlen("COMPOSITE_MLDSA65_RSA3072_PSS_SHA512")) == 0) {
        HLT_SetCertPath(ctxConfig, COMPOSITE_MLDSA65_RSA3072_PSS_SHA512_CA_PATH,
            COMPOSITE_MLDSA65_RSA3072_PSS_SHA512_CHAIN_PATH, COMPOSITE_MLDSA65_RSA3072_PSS_SHA512_EE_PATH,
            COMPOSITE_MLDSA65_RSA3072_PSS_SHA512_PRIV_PATH, "NULL", "NULL");
    } else if (strncmp(cert, "COMPOSITE_MLDSA65_RSA3072_PKCS15_SHA512", strlen("COMPOSITE_MLDSA65_RSA3072_PKCS15_SHA512")) == 0) {
        HLT_SetCertPath(ctxConfig, COMPOSITE_MLDSA65_RSA3072_PKCS15_SHA512_CA_PATH,
            COMPOSITE_MLDSA65_RSA3072_PKCS15_SHA512_CHAIN_PATH, COMPOSITE_MLDSA65_RSA3072_PKCS15_SHA512_EE_PATH,
            COMPOSITE_MLDSA65_RSA3072_PKCS15_SHA512_PRIV_PATH, "NULL", "NULL");
    } else
    if (strncmp(cert, "COMPOSITE_MLDSA65_RSA4096_PSS_SHA512", strlen("COMPOSITE_MLDSA65_RSA4096_PSS_SHA512")) == 0) {
        HLT_SetCertPath(ctxConfig, COMPOSITE_MLDSA65_RSA4096_PSS_SHA512_CA_PATH,
            COMPOSITE_MLDSA65_RSA4096_PSS_SHA512_CHAIN_PATH, COMPOSITE_MLDSA65_RSA4096_PSS_SHA512_EE_PATH,
            COMPOSITE_MLDSA65_RSA4096_PSS_SHA512_PRIV_PATH, "NULL", "NULL");
    } else if (strncmp(cert, "COMPOSITE_MLDSA65_RSA4096_PKCS15_SHA512", strlen("COMPOSITE_MLDSA65_RSA4096_PKCS15_SHA512")) == 0) {
        HLT_SetCertPath(ctxConfig, COMPOSITE_MLDSA65_RSA4096_PKCS15_SHA512_CA_PATH,
            COMPOSITE_MLDSA65_RSA4096_PKCS15_SHA512_CHAIN_PATH, COMPOSITE_MLDSA65_RSA4096_PKCS15_SHA512_EE_PATH,
            COMPOSITE_MLDSA65_RSA4096_PKCS15_SHA512_PRIV_PATH, "NULL", "NULL");
    } else if (strncmp(cert, "COMPOSITE_MLDSA65_ECDSA_P256_SHA512", strlen("COMPOSITE_MLDSA65_ECDSA_P256_SHA512")) == 0) {
        HLT_SetCertPath(ctxConfig, COMPOSITE_MLDSA65_ECDSA_P256_SHA512_CA_PATH,
            COMPOSITE_MLDSA65_ECDSA_P256_SHA512_CHAIN_PATH, COMPOSITE_MLDSA65_ECDSA_P256_SHA512_EE_PATH,
            COMPOSITE_MLDSA65_ECDSA_P256_SHA512_PRIV_PATH, "NULL", "NULL");
    } else if (strncmp(cert, "COMPOSITE_MLDSA65_ECDSA_P384_SHA512", strlen("COMPOSITE_MLDSA65_ECDSA_P384_SHA512")) == 0) {
        HLT_SetCertPath(ctxConfig, COMPOSITE_MLDSA65_ECDSA_P384_SHA512_CA_PATH,
            COMPOSITE_MLDSA65_ECDSA_P384_SHA512_CHAIN_PATH, COMPOSITE_MLDSA65_ECDSA_P384_SHA512_EE_PATH,
            COMPOSITE_MLDSA65_ECDSA_P384_SHA512_PRIV_PATH, "NULL", "NULL");
    } else if (strncmp(cert, "COMPOSITE_MLDSA65_ECDSA_BRAINPOOLP256R1_SHA512",
        strlen("COMPOSITE_MLDSA65_ECDSA_BRAINPOOLP256R1_SHA512")) == 0) {
        HLT_SetCertPath(ctxConfig, COMPOSITE_MLDSA65_ECDSA_BRAINPOOLP256R1_SHA512_CA_PATH,
            COMPOSITE_MLDSA65_ECDSA_BRAINPOOLP256R1_SHA512_CHAIN_PATH,
            COMPOSITE_MLDSA65_ECDSA_BRAINPOOLP256R1_SHA512_EE_PATH,
            COMPOSITE_MLDSA65_ECDSA_BRAINPOOLP256R1_SHA512_PRIV_PATH, "NULL", "NULL");
    } else if (strncmp(cert, "COMPOSITE_MLDSA65_ED25519_SHA512", strlen("COMPOSITE_MLDSA65_ED25519_SHA512")) == 0) {
        HLT_SetCertPath(ctxConfig, COMPOSITE_MLDSA65_ED25519_SHA512_CA_PATH,
            COMPOSITE_MLDSA65_ED25519_SHA512_CHAIN_PATH, COMPOSITE_MLDSA65_ED25519_SHA512_EE_PATH,
            COMPOSITE_MLDSA65_ED25519_SHA512_PRIV_PATH, "NULL", "NULL");
    } else if (strncmp(cert, "COMPOSITE_MLDSA87_ECDSA_P384_SHA512", strlen("COMPOSITE_MLDSA87_ECDSA_P384_SHA512")) == 0) {
        HLT_SetCertPath(ctxConfig, COMPOSITE_MLDSA87_ECDSA_P384_SHA512_CA_PATH,
            COMPOSITE_MLDSA87_ECDSA_P384_SHA512_CHAIN_PATH, COMPOSITE_MLDSA87_ECDSA_P384_SHA512_EE_PATH,
            COMPOSITE_MLDSA87_ECDSA_P384_SHA512_PRIV_PATH, "NULL", "NULL");
    } else if (strncmp(cert, "COMPOSITE_MLDSA87_ECDSA_BRAINPOOLP384R1_SHA512",
        strlen("COMPOSITE_MLDSA87_ECDSA_BRAINPOOLP384R1_SHA512")) == 0) {
        HLT_SetCertPath(ctxConfig, COMPOSITE_MLDSA87_ECDSA_BRAINPOOLP384R1_SHA512_CA_PATH,
            COMPOSITE_MLDSA87_ECDSA_BRAINPOOLP384R1_SHA512_CHAIN_PATH,
            COMPOSITE_MLDSA87_ECDSA_BRAINPOOLP384R1_SHA512_EE_PATH,
            COMPOSITE_MLDSA87_ECDSA_BRAINPOOLP384R1_SHA512_PRIV_PATH, "NULL", "NULL");
    } else if (strncmp(cert, "COMPOSITE_MLDSA87_RSA3072_PSS_SHA512", strlen("COMPOSITE_MLDSA87_RSA3072_PSS_SHA512")) == 0) {
        HLT_SetCertPath(ctxConfig, COMPOSITE_MLDSA87_RSA3072_PSS_SHA512_CA_PATH,
            COMPOSITE_MLDSA87_RSA3072_PSS_SHA512_CHAIN_PATH, COMPOSITE_MLDSA87_RSA3072_PSS_SHA512_EE_PATH,
            COMPOSITE_MLDSA87_RSA3072_PSS_SHA512_PRIV_PATH, "NULL", "NULL");
    } else if (strncmp(cert, "COMPOSITE_MLDSA87_RSA4096_PSS_SHA512", strlen("COMPOSITE_MLDSA87_RSA4096_PSS_SHA512")) == 0) {
        HLT_SetCertPath(ctxConfig, COMPOSITE_MLDSA87_RSA4096_PSS_SHA512_CA_PATH,
            COMPOSITE_MLDSA87_RSA4096_PSS_SHA512_CHAIN_PATH, COMPOSITE_MLDSA87_RSA4096_PSS_SHA512_EE_PATH,
            COMPOSITE_MLDSA87_RSA4096_PSS_SHA512_PRIV_PATH, "NULL", "NULL");
    } else if (strncmp(cert, "COMPOSITE_MLDSA87_ECDSA_P521_SHA512", strlen("COMPOSITE_MLDSA87_ECDSA_P521_SHA512")) == 0) {
        HLT_SetCertPath(ctxConfig, COMPOSITE_MLDSA87_ECDSA_P521_SHA512_CA_PATH,
            COMPOSITE_MLDSA87_ECDSA_P521_SHA512_CHAIN_PATH, COMPOSITE_MLDSA87_ECDSA_P521_SHA512_EE_PATH,
            COMPOSITE_MLDSA87_ECDSA_P521_SHA512_PRIV_PATH, "NULL", "NULL");
    }
}
 ...
 */
/* BEGIN_CASE */
void SDV_TLS13_COMPOSITE_SIGNATURE(char *signature, char *cert)
{
    CONNECT(TLS1_3, TCP, "HITLS_AES_256_GCM_SHA384", "HITLS_EC_GROUP_SECP256R1", signature, 0, cert);
}
/* END_CASE */
