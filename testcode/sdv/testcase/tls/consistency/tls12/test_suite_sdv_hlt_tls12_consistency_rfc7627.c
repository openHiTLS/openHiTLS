...
void SDV_TLS_TLS12_RFC7627_CONSISTENCY_EXTENDED_MASTER_SECRET_FUNC_TC008(int version, int connType)
{
    ...
    serverConfigId = HLT_RpcProviderTlsNewCtx(remoteProcess, version, false, serverCtxConfig->providerPath,
        serverCtxConfig->providerNames, serverCtxConfig->providerLibFmts, serverCtxConfig->providerCnt,
        serverCtxConfig->attrName);
    serverConfigId2 = HLT_RpcProviderTlsNewCtx(remoteProcess, version, false, serverCtxConfig2->providerPath,
        serverCtxConfig2->providerNames, serverCtxConfig2->providerLibFmts, serverCtxConfig2->providerCnt,
        serverCtxConfig2->attrName);
#else
    serverConfigId = HLT_RpcTlsNewCtx(remoteProcess, version, false);
