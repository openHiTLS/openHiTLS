...
void SDV_HITLS_X509_CtrlCert_TC001(void)
{
    ...
    ASSERT_EQ(HITLS_X509_CtrlCert(&cert, HITLS_X509_CERT_GET_SUBJECT_DNNAME, NULL, 0), HITLS_X509_ERR_INVALID_PARAM);
    ASSERT_EQ(HITLS_X509_CtrlCert(&cert, HITLS_X509_CERT_GET_ISSUER_DNNAME, NULL, 0), HITLS_X509_ERR_INVALID_PARAM);
    ASSERT_EQ(HITLS_X509_CtrlCert(&cert, HITLS_X509_CERT_GET_SERIALNUM, NULL, 0), HITLS_X509_ERR_INVALID_PARAM);
    ASSERT_EQ(HITLS_X509_CtrlCert(&cert, HITLS_X509_CERT_GET_BEFORE_TIME, NULL, 0), HITLS_X509_ERR_INVALID_PARAM);
    ASSERT_EQ(HITLS_X509_CtrlCert(&cert, HITLS_X509_CERT_GET_AFTER_TIME, NULL, 0), HITLS_X509_ERR_INVALID_PARAM);
exit:
    BSL_GLOBAL_DeInit();
}
/* END_CASE */
