    ...
    Hex *addin1, Hex *entropyPR1, Hex *addin2, Hex *entropyPR2, Hex *retBits)
{
    ...
    ASSERT_EQ(BSL_PARAM_InitValue(&param[1],
        CRYPT_PARAM_SEED_GETENTROPY, BSL_PARAM_TYPE_FUNC_PTR, seedMeth.getEntropy, 0), BSL_SUCCESS);
    ASSERT_EQ(BSL_PARAM_InitValue(&param[2],
        CRYPT_PARAM_SEED_CLEANENTROPY, BSL_PARAM_TYPE_FUNC_PTR, seedMeth.cleanEntropy, 0), BSL_SUCCESS);
    ASSERT_EQ(BSL_PARAM_InitValue(&param[3],
        CRYPT_PARAM_SEED_GETNONCE, BSL_PARAM_TYPE_FUNC_PTR, seedMeth.getNonce, 0), BSL_SUCCESS);
    ASSERT_EQ(BSL_PARAM_InitValue(&param[4],
        CRYPT_PARAM_SEED_CLEANNONCE, BSL_PARAM_TYPE_FUNC_PTR, seedMeth.cleanNonce, 0), BSL_SUCCESS);
