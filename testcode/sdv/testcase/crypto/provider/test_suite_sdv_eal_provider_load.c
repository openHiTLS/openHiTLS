...
static int32_t SigAlgCapsCallback(BSL_Param *param, void *args)
{
    ...
    BSL_Param *keyTypeOidParam = BSL_PARAM_FindParam(param, CRYPT_PARAM_CAP_TLS_SIGNALG_KEY_TYPE_OID);
    ASSERT_TRUE(keyTypeOidParam != NULL);
    ASSERT_EQ(keyTypeOidParam->valueType, BSL_PARAM_TYPE_CTX_PTR);
    ASSERT_TRUE(keyTypeOidParam->valueLen == 0);
    keyTypeOidParam->useLen = 0;
    ...
    BSL_Param *paraOidParam = BSL_PARAM_FindParam(param, CRYPT_PARAM_CAP_TLS_SIGNALG_PARA_OID);
    ASSERT_TRUE(paraOidParam != NULL);
    ASSERT_EQ(paraOidParam->valueType, BSL_PARAM_TYPE_CTX_PTR);
    ASSERT_TRUE(paraOidParam->valueLen == 0);
    paraOidParam->useLen = 0;
    ...
    ASSERT_TRUE(signHashAlgOidParam != NULL);
    ASSERT_EQ(signHashAlgOidParam->valueType, BSL_PARAM_TYPE_CTX_PTR);
    ASSERT_TRUE(signHashAlgOidParam->valueLen == 0);
    signHashAlgOidParam->useLen = 0;
    ...
    ASSERT_TRUE(hashAlgOidParam != NULL);
    ASSERT_EQ(hashAlgOidParam->valueType, BSL_PARAM_TYPE_CTX_PTR);
    ASSERT_TRUE(hashAlgOidParam->valueLen == 0);
    hashAlgOidParam->useLen = 0;
    ...
    BSL_OBJ_Create(BSL_OBJ_TYPE_CTX, keyTypeOidParam->value, 0);
