...
void SDV_CRYPT_EAL_HPKE_API_TC005(void)
{
    ...
    ctxS = CRYPT_EAL_HpkeNewCtx(CRYPT_HPKE_SENDER, CRYPT_HPKE_MODE_BASE, cipherSuite, NULL, NULL);
    ASSERT_TRUE(ctxS == NULL);

    ctxR = CRYPT_EAL_HpkeNewCtx(CRYPT_HPKE_RECIPIENT, CRYPT_HPKE_MODE_BASE, cipherSuite, NULL, NULL);
    ASSERT_TRUE(ctxR == NULL);
    ...
    // ctxS = CRYPT_EAL_HpkeNewCtx(CRYPT_HPKE_SENDER, CRYPT_HPKE_MODE_BASE, cipherSuite, NULL, "hitls");
    // ASSERT_TRUE(ctxS == NULL);
