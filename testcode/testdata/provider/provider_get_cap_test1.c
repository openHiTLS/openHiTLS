...
#define NEW_KEM_ALGID (BSL_CID_MAX + 3)
#define NEW_KEM_PARAM_ID (BSL_CID_MAX + 4)

#define NEW_SIGN_HASH_ALGID (BSL_CID_MAX + 5)
#define NEW_HASH_ALGID (BSL_CID_MAX + 6)
...
static int32_t TestKemCtrl(TestKemKeyCtx *ctx, int32_t cmd, void *val, uint32_t valLen)
{
    ...
    switch (cmd) {
        case CRYPT_CTRL_SET_PARAM_BY_ID:
            printf("CRYPT_CTRL_SET_PARAM_BY_ID \n");
