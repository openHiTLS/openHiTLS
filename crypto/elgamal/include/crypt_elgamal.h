...
#define ELGAMAL_MAX_MODULUS_BITS 16384
   ...
   */
  int32_t CRYPT_ELGAMAL_PubEnc(const CRYPT_ELGAMAL_Ctx *ctx,const uint8_t *input,uint32_t inputLen,uint8_t *out1,uint32_t *out1Len,uint8_t *out2, uint32_t *out2Len);
   ...
   */
  int32_t CRYPT_ELGAMAL_PrvDec(const CRYPT_ELGAMAL_Ctx *ctx,const BN_BigNum *c1,const BN_BigNum *c2,uint32_t bits,uint8_t *out,uint32_t *outLen);
