...
int32_t CRYPT_EAL_PkeyBlind(CRYPT_EAL_PkeyCtx *pkey, int32_t algId, const uint8_t *input, uint32_t inputLen,
    uint8_t *out, uint32_t *outLen)
{
    ...
    int32_t ret = pkey->method->blind(pkey->key, algId, input, inputLen, out, outLen);
