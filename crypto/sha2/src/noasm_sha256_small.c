...
#if defined(HITLS_CRYPTO_SHA256) && defined(HITLS_CRYPTO_SHA256_SMALLER)
...
#define ROUND(a,b,c,d,e,f,g,h,i,k) do { \
    uint32_t t1 = (h) + (ROTR32(e,6) ^ ROTR32(e,11) ^ ROTR32(e,25)) + ((g) ^ ((e) & ((f) ^ (g)))) + (k) + (i); \
...
#endif // HITLS_CRYPTO_SHA256 && HITLS_CRYPTO_SHA256_SMALLER
