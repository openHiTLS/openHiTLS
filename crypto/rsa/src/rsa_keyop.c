...
static int32_t GetAndCheckPrvKey(CRYPT_RSA_Ctx *ctx, BSL_Param *para, CRYPT_RsaPrvParam *prv)
{
    ...
    prv->n = (BSL_Param *)BSL_PARAM_FindParam(para, CRYPT_PARAM_RSA_N);
    prv->d = (BSL_Param *)BSL_PARAM_FindParam(para, CRYPT_PARAM_RSA_D);
    prv->e = (BSL_Param *)BSL_PARAM_FindParam(para, CRYPT_PARAM_RSA_E);
    prv->p = (BSL_Param *)BSL_PARAM_FindParam(para, CRYPT_PARAM_RSA_P);
    prv->q = (BSL_Param *)BSL_PARAM_FindParam(para, CRYPT_PARAM_RSA_Q);
    prv->dP = (BSL_Param *)BSL_PARAM_FindParam(para, CRYPT_PARAM_RSA_DP);
    prv->dQ = (BSL_Param *)BSL_PARAM_FindParam(para, CRYPT_PARAM_RSA_DQ);
    prv->qInv = (BSL_Param *)BSL_PARAM_FindParam(para, CRYPT_PARAM_RSA_QINV);
...
int32_t CRYPT_RSA_GetPubKey(const CRYPT_RSA_Ctx *ctx, BSL_Param *para)
{
    ...
    BSL_Param *e = (BSL_Param *)BSL_PARAM_FindParam(para, CRYPT_PARAM_RSA_E);
    ...
    BSL_Param *n = (BSL_Param *)BSL_PARAM_FindParam(para, CRYPT_PARAM_RSA_N);
