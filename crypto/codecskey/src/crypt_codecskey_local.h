...
#define CRYPT_ASN1_CTX_SPECIFIC_TAG_RSAOAEP_HASH    0
#define CRYPT_ASN1_CTX_SPECIFIC_TAG_RSAOAEP_MASKGEN 1
#define CRYPT_ASN1_CTX_SPECIFIC_TAG_RSAOAEP_PSOURCE 2
