...
#ifndef CRYPT_MODES_CHACHA20_H
#define CRYPT_MODES_CHACHA20_H
...
#define MODES_CHACHA20_NewCtx MODES_CipherNewCtx
#define MODES_CHACHA20_NewCtxEx MODES_CipherNewCtxEx
...
#define MODES_CHACHA20_DeInitCtx MODES_CipherDeInitCtx
int32_t MODES_CHACHA20_Ctrl(MODES_CipherCtx *modeCtx, int32_t cmd, void *val, uint32_t valLen);
#define MODES_CHACHA20_FreeCtx MODES_CipherFreeCtx
#define MODES_CHACHA20_DupCtx MODES_CipherDupCtx
