...
const CRYPT_EAL_Func g_defEalSignComposite[] = {
    ...
    {CRYPT_EAL_IMPLPKEYSIGN_SIGNDATA, (CRYPT_EAL_ImplPkeySignData)CRYPT_COMPOSITE_SignData},
    {CRYPT_EAL_IMPLPKEYSIGN_VERIFY, (CRYPT_EAL_ImplPkeyVerify)CRYPT_COMPOSITE_Verify},
    {CRYPT_EAL_IMPLPKEYSIGN_VERIFYDATA, (CRYPT_EAL_ImplPkeyVerifyData)CRYPT_COMPOSITE_VerifyData},
    CRYPT_EAL_FUNC_END,
};
#endif
