...
static const CRYPT_EAL_AlgInfo defCiphers[] = {
    {CRYPT_CIPHER_AES128_CBC, defCbc, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_AES192_CBC, defCbc, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_AES256_CBC, defCbc, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_AES128_CTR, defCtr, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_AES192_CTR, defCtr, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_AES256_CTR, defCtr, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_AES128_ECB, defEcb, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_AES192_ECB, defEcb, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_AES256_ECB, defEcb, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_AES128_CCM, defCcm, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_AES192_CCM, defCcm, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_AES256_CCM, defCcm, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_AES128_GCM, defGcm, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_AES192_GCM, defGcm, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_AES256_GCM, defGcm, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_CHACHA20_POLY1305, defChaCha, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_SM4_XTS, defXts, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_SM4_CBC, defCbc, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_SM4_ECB, defEcb, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_SM4_CTR, defCtr, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_SM4_GCM, defGcm, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_SM4_CFB, defCfb, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_SM4_OFB, defOfb, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_AES128_CFB, defCfb, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_AES192_CFB, defCfb, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_AES256_CFB, defCfb, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_AES128_OFB, defOfb, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_AES192_OFB, defOfb, CRYPT_EAL_DEFAULT_ATTR},
    {CRYPT_CIPHER_AES256_OFB, defOfb, CRYPT_EAL_DEFAULT_ATTR},
    CRYPT_EAL_ALGINFO_END
};
