...
static const CRYPT_EAL_AlgInfo g_defEalMds[] = {
    ...
    {CRYPT_MD_BLAKE2S256, g_defEalMdBlake2s256, CRYPT_EAL_DEFAULT_ATTR},
...
static const CRYPT_EAL_AlgInfo g_defEalKeyMgmt[] = {
    ...
    {CRYPT_PKEY_HSS_LMS, g_defEalKeyMgmtHss, CRYPT_EAL_DEFAULT_ATTR},
#endif
...
#endif
#ifdef HITLS_CRYPTO_HSS_LMS
    {CRYPT_PKEY_HSS_LMS, g_defEalSignHss, CRYPT_EAL_DEFAULT_ATTR},
#endif
    CRYPT_EAL_ALGINFO_END
};
#endif
...
#endif
#ifdef HITLS_CRYPTO_DSA
    {CRYPT_PKEY_DSA, g_defEalSubPubKeyDer2DsaKey,
        "provider=default, inFormat=ASN1, inType=PUBKEY_SUBKEY, outFormat=OBJECT, outType=LOW_KEY"},
#endif
#ifdef HITLS_CRYPTO_MLDSA
...
#endif
#ifdef HITLS_CRYPTO_DSA
    {CRYPT_PKEY_DSA, g_defEalSubPubKeyWithoutSeqDer2DsaKey,
        "provider=default, inFormat=ASN1, inType=PUBKEY_SUBKEY_WITHOUT_SEQ, outFormat=OBJECT, outType=LOW_KEY"},
#endif
#ifdef HITLS_CRYPTO_ED25519
