...
static const TLS_GroupInfo g_tlsGroupInfo[] = {
    ...
    },
    {
        ...
        192,
        4588,
        1184 + 32, 32 + 32, 1088 + 32, // pubkeyLen=32, sharedkeyLen=32 (256 bits)
    ...
    },
    {
        ...
        192,
        4587,
        1184 + 65, 32 + 32, 1088 + 65, // pubkeyLen=32, sharedkeyLen=32 (256 bits)
        TLS13_VERSION_BIT, // versionBits
        true,
    },
    {
        ...
        256,
        4589,
        1568 + 97, 32 + 48, 1568 + 97, // pubkeyLen=32, sharedkeyLen=32 (256 bits)
        TLS13_VERSION_BIT, // versionBits
        true,
    },
    {
