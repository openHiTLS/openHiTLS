...
static const TLS_SigSchemeInfo g_signSchemeInfo[] = {
    {
        ...
        {{7, "\52\206\110\316\75\2\1", BSL_OID_GLOBAL}, "EC-PUBLICKEY", BSL_CID_EC_PUBLICKEY},
        CRYPT_ECC_NISTP521,
    ...
    },
    {
        ...
        {{7, "\53\145\160", BSL_OID_GLOBAL}, "ED25519", BSL_CID_ED25519}, // unsupported type for cert or key decoding
        0,
        NULL,
        BSL_CID_ED25519,
        {{7, "\53\145\160", BSL_OID_GLOBAL}, "ED25519", BSL_CID_ED25519}, // unsupported type for cert decoding
        HITLS_SIGN_ED25519,
        HITLS_HASH_SHA_512,
        {{9, "\140\206\110\1\145\3\4\2\3", BSL_OID_GLOBAL}, "SHA512", BSL_CID_SHA512},
        128,
    ...
    },
    {
        ...
        {{7, "\52\206\110\316\75\2\1", BSL_OID_GLOBAL}, "EC-PUBLICKEY", BSL_CID_EC_PUBLICKEY},
        CRYPT_ECC_NISTP256,
        {{5, "\53\201\4\0\41", BSL_OID_GLOBAL}, "SECP256R1", BSL_CID_SECP256R1},
    ...
    },
    {
        ...
        {{{7, "\52\206\110\316\70\4\1", BSL_OID_GLOBAL}, "DSAENCRYPTION", BSL_CID_DSA}, "DSAENCRYPTION", BSL_CID_DSA},
        0,
        NULL,
    ...
    },
    {
        ...
        TLS_CERT_KEY_TYPE_DSA,
        {{7, "\52\206\110\316\70\4\1", BSL_OID_GLOBAL}, "DSAENCRYPTION", BSL_CID_DSA},
        0,
        NULL,
    ...
    },
    {
        ...
        {{8, "\52\206\110\316\75\4\3\1", BSL_OID_GLOBAL}, "ECDSAWITHSHA1", BSL_CID_ECDSAWITHSHA1},
        HITLS_SIGN_ECDSA,
        HITLS_HASH_SHA1,
...
static int32_t BuildTlsSigAlgParam(const TLS_SigSchemeInfo *sigSchemeInfo, BSL_Param *param)
{
    ...
    RETURN_RET_IF_ERR(BSL_PARAM_InitValue(&param[3], CRYPT_PARAM_CAP_TLS_SIGNALG_KEY_TYPE_OID, BSL_PARAM_TYPE_CTX_PTR,
        (void *)(uintptr_t)sigSchemeInfo->keyTypeOid, 0), ret);
    ...
    RETURN_RET_IF_ERR(BSL_PARAM_InitValue(&param[5], CRYPT_PARAM_CAP_TLS_SIGNALG_PARA_OID, BSL_PARAM_TYPE_CTX_PTR,
        (void *)(uintptr_t)sigSchemeInfo->paraOid, 0), ret);
    ...
    RETURN_RET_IF_ERR(BSL_PARAM_InitValue(&param[7], CRYPT_PARAM_CAP_TLS_SIGNALG_SIGNWITHMD_OID, BSL_PARAM_TYPE_CTX_PTR,
        (void *)(uintptr_t)sigSchemeInfo->signHashAlgOid, 0), ret);
    ...
    RETURN_RET_IF_ERR(BSL_PARAM_InitValue(&param[10], CRYPT_PARAM_CAP_TLS_SIGNALG_MD_OID, BSL_PARAM_TYPE_CTX_PTR,
        (void *)(uintptr_t)sigSchemeInfo->hashAlgOid, 0), ret);
