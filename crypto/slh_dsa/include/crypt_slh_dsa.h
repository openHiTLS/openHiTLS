...
// The length of "seed" and "out" is n, the max length is SLH_DSA_MAX_N
typedef int32_t (*PTHF)(const SlhDsaCtx *ctx, bool isHT, const uint8_t *seed, const SlhDsaAdrs *adrs,
                        const uint8_t *msg, uint32_t msgLen, uint8_t *out);

// The length of "prf", "rand" and "out" is n, the max length is SLH_DSA_MAX_N
typedef int32_t (*PRFmsg)(const SlhDsaCtx *ctx, const uint8_t *prf, const uint8_t *rand, const uint8_t *msg,
...
typedef int32_t (*Hmsg)(const SlhDsaCtx *ctx, const uint8_t *r, const uint8_t *seed, const uint8_t *root,
                        const uint8_t *msg, uint32_t msgLen, uint8_t *out);
