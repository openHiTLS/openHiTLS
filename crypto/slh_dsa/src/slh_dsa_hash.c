...
static int32_t CalcMultiMsgHash(CRYPT_MD_AlgId mdId, const CRYPT_ConstData *hashData, uint32_t hashDataLen, uint8_t *out, uint32_t outLen)
{
    uint8_t tmp[MAX_MDSIZE] = {0};
    uint32_t tmpLen = sizeof(tmp);
    int32_t ret = CalcHash(EAL_MdFindMethod(mdId), hashData, hashDataLen,
                           tmp, &tmpLen);
...
static int32_t PrfmsgShake256(const CryptSlhDsaCtx *ctx, const uint8_t *rand, const uint8_t *msg,
...
static int32_t HmsgShake256(const CryptSlhDsaCtx *ctx, const uint8_t *r, const uint8_t *msg, uint32_t msgLen, uint8_t *out)
{
    uint32_t n = ctx->para.n;
...
static int32_t HShake256(const CryptSlhDsaCtx *ctx, const SlhDsaAdrs *adrs, const uint8_t *msg, uint32_t msgLen, uint8_t *out)
{
    uint32_t n = ctx->para.n;
    const CRYPT_ConstData hashData[] = {
        {ctx->prvKey.pub.seed, n},
...
static int32_t TlShake256(const CryptSlhDsaCtx *ctx, const SlhDsaAdrs *adrs,
                        const uint8_t *msg, uint32_t msgLen, uint8_t *out)
{
    return HShake256(ctx, adrs, msg, msgLen, out);
}

static int32_t FShake256(const CryptSlhDsaCtx *ctx, const SlhDsaAdrs *adrs,
                        const uint8_t *msg, uint32_t msgLen, uint8_t *out)
{
    return HShake256(ctx, adrs, msg, msgLen, out);
}
...
static int32_t Prfmsg(const CryptSlhDsaCtx *ctx, const uint8_t *rand, const uint8_t *msg,
...
static int32_t PrfmsgSha256(const CryptSlhDsaCtx *ctx, const uint8_t *rand, const uint8_t *msg,
                          uint32_t msgLen, uint8_t *out)
{
    return Prfmsg(ctx, rand, msg, msgLen, out, CRYPT_MAC_HMAC_SHA256);
}
static int32_t PrfmsgSha512(const CryptSlhDsaCtx *ctx, const uint8_t *rand, const uint8_t *msg,
                          uint32_t msgLen, uint8_t *out)
{
...
static int32_t HmsgSha256(const CryptSlhDsaCtx *ctx, const uint8_t *r, const uint8_t *msg, uint32_t msgLen, uint8_t *out)
{
    return HmsgSha(ctx, r, ctx->prvKey.pub.seed, ctx->prvKey.pub.root, msg, msgLen, out, CRYPT_MD_SHA256);
}

static int32_t HmsgSha512(const CryptSlhDsaCtx *ctx, const uint8_t *r, const uint8_t *msg, uint32_t msgLen, uint8_t *out)
{
...
static int32_t HSha256(const CryptSlhDsaCtx *ctx, const SlhDsaAdrs *adrs,
                        const uint8_t *msg, uint32_t msgLen, uint8_t *out)
{
    uint32_t n = ctx->para.n;
    uint8_t padding[SHA256_PADDING_LEN] = {0};
...
static int32_t FSha256(const CryptSlhDsaCtx *ctx, const SlhDsaAdrs *adrs,
                        const uint8_t *msg, uint32_t msgLen, uint8_t *out)
{
    return HSha256(ctx, adrs, msg, msgLen, out);
}

static int32_t TlSha256(const CryptSlhDsaCtx *ctx, const SlhDsaAdrs *adrs,
                        const uint8_t *msg, uint32_t msgLen, uint8_t *out)
{
    return HSha256(ctx, adrs, msg, msgLen, out);
}

static int32_t HSha512(const CryptSlhDsaCtx *ctx, const SlhDsaAdrs *adrs,
                        const uint8_t *msg, uint32_t msgLen, uint8_t *out)
{
    uint32_t n = ctx->para.n;
...
static int32_t TlSha512(const CryptSlhDsaCtx *ctx, const SlhDsaAdrs *adrs,
                        const uint8_t *msg, uint32_t msgLen, uint8_t *out)
{
