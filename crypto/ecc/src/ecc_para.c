...
typedef struct {
    ...
    defined(HITLS_CRYPTO_CURVE_NISTP192) || defined(HITLS_CRYPTO_CURVE_SM2)
...
#ifdef HITLS_CRYPTO_CURVE_NISTP192
    { CRYPT_ECC_NISTP192, &paraNistP192 },
#endif
#ifdef HITLS_CRYPTO_CURVE_NISTP224
